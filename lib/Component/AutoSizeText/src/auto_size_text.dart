...
class _AutoSizeTextState extends State<AutoSizeText> {
  ...
  bool _checkTextFits(
    ...
    if (!widget.wrapWords) {
      ...
      final wordWrapTextPainter = MongolTextPainter(
        text: TextSpan(
          style: text.style,
          text: words.join('\n'),
        ),
        textAlign: widget.textAlign ?? MongolTextAlign.top,
        textScaleFactor: scale,
        maxLines: words.length,
      );

      wordWrapTextPainter.layout(maxHeight: constraints.maxHeight);
    ...
    textPainter.layout(maxHeight: constraints.maxHeight);
